...
2. Talk about 3 different things you can do to ensure your website is accessible. 
    ...
    Enable resizable text (use percentages instead of pixels)

3. How would you explain the concept of a variable to someone new to programming?
    A variable holds data for a program to use.

4. What is the purpose of using functions in code?
    A function can be written once and then used however many times it needs to be, contrasted with rewriting the same code over and over again.
